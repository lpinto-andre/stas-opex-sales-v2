      ...
      <table className="w-full table-auto text-sm">
        ...
        <tbody>
          {rows.map((row, i) => <tr key={`${row.part_num}-${i}`} className="border-b border-[var(--border)] hover:bg-[var(--surface)]/60 align-top">
            ...
            <td className="px-3 py-2 whitespace-nowrap">{score3(Number(row.revenue_score))}</td><td className="px-3 py-2 whitespace-nowrap">{score3(Number(row.orders_score))}</td><td className="px-3 py-2 whitespace-nowrap">{score3(Number(row.profit_score))}</td><td className="px-3 py-2 whitespace-nowrap">{score3(Number(row.margin_score))}</td><td className="px-3 py-2 whitespace-nowrap">{score3(Number(row.trend_score))}</td><td className="px-3 py-2 whitespace-nowrap">{score3(Number(row.active_score))}</td><td className="px-3 py-2 whitespace-nowrap">{score3(Number(row.final_score))}</td>
