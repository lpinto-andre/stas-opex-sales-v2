...
const navLabel: Record<string, string> = { '/dataset': 'Dataset Manager', '/explorer': 'Dashboard', '/group-by': 'Group By', '/database': 'Parts Database', '/pricing': 'Finance', '/top-items': 'Top Items', '/labels': 'Labels' };
